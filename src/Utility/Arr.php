...
class Arr
{
     ...
     * @return bool
     */
    public static function isEmptyArray(mixed $array) : bool
    {
        return $array === [];
    }
     ...
     * @return array
     */
    public static function only(array $array, string|array $columns) : array
    {
        $values = [];
     ...
     * @throws \Exception
     */
    public static function pluck(array $array, array|string $columns, ?string $index = null) : array
    {
        $list = [];
        $columns = (array) $columns;
     ...
     * @throws \Exception
     */
    public static function indexBy(string $index, array $array, bool $unique = true) : array
    {
        $indexed_list = [];
     ...
     * @return array
     */
    public static function replaceRecursivePreferNew(array $current_array, array $new_array, array $stops = []) : array
    {
        if(!empty($stops)) {
     ...
     */
    public static function get(array|\ArrayAccess $array, string|array $needle, mixed $default = null) : mixed
    {
     ...
     * @return bool
     */
    public static function has(array|\ArrayAccess $array, string|array $needle) : bool
    {
     ...
     * @return array
     */
    public static function set(string $dots, array $array, mixed $value) : array
    {
        $set = &$array;
        $traverse = explode('.', $dots);
     ...
     *
     * If value is true reduce the keys to a list with a space separator.
     *
     * @param array $array
     *
     * @return string
     */
    public static function reduceAllowedStr(array $array): string
    {
        $reduced = '';
     ...
     *
     * @param array|string $dots
     * @param ArrayObject|array $arr
     * @param callable $callback
     *
     * @return mixed
     */
    public static function format(array|string $dots, ArrayObject|array &$arr, callable $callback): mixed
    {
        $loc = &$arr;
     ...
     */
    public static function isAccessible(mixed $value) : bool
    {
     ...
     * @return bool
     */
    public static function keysExist(array $keys, array $array): bool
    {
     ...
     * @return mixed|null
     */
    public static function first(array|ArrayObject $array, ?callable $callback = null, $default = null) : mixed
    {
     ...
     * @return mixed|null
     */
    public static function last(ArrayObject|array $array, ?callable $callback = null, $default = null) : mixed
    {
