...
class Data
{
     ...
     */
    public static function value(mixed $value, ?array $args = null): mixed
    {
     ...
     * @return Nil
     */
    public static function nil(array|object $value) : Nil
    {
     ...
     */
    public static function map(callable $callback, mixed $value) : mixed
    {
        if ( is_array( $value ) ) {
     ...
     * @return bool
     */
    public static function emptyOrBlankRecursive(mixed $value) : bool
    {
        if (is_array($value)) {
            $empty = true;
            array_walk_recursive($value, function($item) use (&$empty) {
     ...
     * @return mixed
     */
    public static function walk(string|array $dots, array|object $array, mixed $default = null) : mixed
    {
     ...
     * @return mixed
     */
    public static function get(object|array $data, string|array $dots, mixed $default = null) : mixed
    {
        $dots = (array) $dots;
        $index = count($dots) > 1;
        $return = null;
     ...
     * @throws \Exception
     */
    public static function createMapIndexBy(string $index, array|\Iterator $array, bool $unique = true) : array
    {
        $indexed_list = [];
     ...
     */
    public static function cast(mixed $value, string|callable $type) : mixed
    {
        // Callback
        if (is_callable($type)) {
